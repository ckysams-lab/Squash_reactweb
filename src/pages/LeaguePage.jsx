...
// Version 8.0: 🌟 日常聯賽系統大升級！區分「單場友誼賽」與全新的「批量日常聯賽生成器」，一鍵生成整學期待定賽程。
...
export default function LeaguePage({
  ...
  const handleCreateDailyLeague = async () => {
      ...
      try {
          ...
          // 單循環演算法 (Round Robin) - 所有選擇的球員互相對戰一次
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
          <div className="flex items-center gap-4">
             ...
             <div>
               ...
               <p className="text-slate-500 text-sm mt-1 font-bold">查看賽事排位與大賽賽程 <span className="ml-2 bg-slate-100 px-2 py-0.5 rounded text-xs text-blue-600">v8.0 聯賽進化版</span></p>
             </div>
          </div>
